...
function Calendar({
  ...
  // Custom dropdown components for month/year navigation
  function CustomDropdown({ value, onChange, children, ...props }: DropdownProps) {
    ...
    return (
      ...
      >
        <SelectTrigger className="h-8 w-[130px] border-none bg-transparent font-medium">
